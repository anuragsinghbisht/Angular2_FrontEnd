  ...
  rows: [
    {
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/2knt3j3lqm43cll/Google.jpg?dl=0'
    },
    {
      category: 'Companies',
      title: 'DELL',
      ...
      description:
        'Dell Inc. (stylized as DELL) is a multinational computer technology company based in Round Rock, Texas and, along with Dell EMC, is a subsidiary of Dell Technologies, one of the largest technology companies in the world with 138,000 employees.[4] Dell manufactures, sells, repairs, and supports personal computers (PCs), servers, data storage devices, network switches, computer software, computer peripherals, high-definition televisions, cameras, printers, and electronics built by other manufacturers. The company is well known for its innovations in supply chain management and e-commerce, particularly its direct-sales model',
      imageHref:
        'https://dl.dropboxusercontent.com/s/qe282y489c4zw83/DELL.png?dl=0'
    },
    {
      category: 'Companies',
      title: 'Infosys',
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/kmwpe53nlkb2sfg/Infosys.png?dl=0'
    },
    {
      category: 'Companies',
      title: 'Microsoft',
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/02wqavlmccirhro/Microsoft.png?dl=0'
    },
    {
      category: 'Companies',
      title: 'NewFirm',
    ...
    },
    {
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/6cjtg8ove416ef7/html5.png?dl=0'
    },
    {
      category: 'Technologies',
      title: 'CSS3',
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/w9wcd9ew05xtth5/css3.png?dl=0'
    },
    {
      category: 'Technologies',
      title: 'Angular',
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/0rehvtpw7dlqstx/Angular.png?dl=0'
    },
    {
      category: 'Technologies',
      title: 'JQuery',
      ...
      imageHref:
        'https://dl.dropboxusercontent.com/s/a1ucszgy8klkpzt/JQuery.png?dl=0'
    }
  ]
};
